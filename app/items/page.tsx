  ...
  return (
    <div className="p-8 max-w-[1600px] mx-auto min-h-full">
      <header className="mb-10">
        ...
        <p className="text-white/50 text-sm mt-2">Bazada mavjud barcha mahsulotlar ro'yxati va holati</p>
      </header>

      <div className="glass-card rounded-[2.5rem] overflow-hidden flex flex-col min-h-[500px] border border-white/5 shadow-2xl">
        <div className="p-8 border-b border-white/5 flex flex-col sm:flex-row justify-between items-center gap-4 bg-white/[0.02]">
          ...
          <p className="text-[10px] text-white/30 font-bold uppercase tracking-[0.2em] ml-auto">
